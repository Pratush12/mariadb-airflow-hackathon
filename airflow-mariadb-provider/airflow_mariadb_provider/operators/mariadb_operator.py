...
# distributed with this work for additional informationQQ
...
class MariaDBOperator(SQLExecuteQueryOperator):
    """
    Executes sql code in a MariaDB database
    """
    ...
    def __init__(
        self, *, mariadb_conn_id: str = "mariadb_default", database: str | None = None, **kwargs
    ) -> None:
